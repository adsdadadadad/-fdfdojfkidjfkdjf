...
clear()
title("Promotion Checker - Made By ._yb#0000 | Alfred")
clear()
bnr = pyfiglet.figlet_format("By ._yb")

colors.banner(bnr+"\n")
colors.warning("Made By ._yb#0000\n")
colors.ask("Delay")
delay = int(input(">>> "))
colors.ask("Discord User Account Token [ Required To Bypass Rate Limit ]\n>>> Daldiya Hei Bsdk & Faltu Token Hei Wo Chutiye !!\n")
token = "token f"#input(">>> ")
...
if r.status_code in [201,204,200]:
  ...
  colors.error("Chutiya Invalid Token !!")
  sys.exit()
